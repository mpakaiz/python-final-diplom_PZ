...
INSTALLED_APPS = [
    ...
    'reference.netology_pd_diplom.backend.apps.BackendConfig',
    'rest_framework',
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv("POSTGRES_DB", "reference"),
        'PASSWORD': os.getenv("POSTGRES_PASSWORD", "reference"),
        'USER': os.getenv("POSTGRES_USER", "reference"),
